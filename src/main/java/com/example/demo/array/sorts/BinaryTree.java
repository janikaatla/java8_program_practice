...
public class BinaryTree {
    ...
    private int findSubTreeTotal(Node root) {
        if (root == null) {
            return 0;
        }
        return root.key+findSubTreeTotal(root.left)+findSubTreeTotal(root.right);
    }
    ...
    public static void main(String[] args) {
        ...
        int left=tree.root.key + tree.findSubTreeTotal(tree.root.left);
        int right=tree.root.key + tree.findSubTreeTotal(tree.root.right);
        System.out.println("Left side Total: "+left);
        System.out.println("Right side Total: "+right);
